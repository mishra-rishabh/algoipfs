...
const IV_LENGTH = 16 ;  // For AES, Initialization Vector (IV) is always 16

module.exports = class IPFSPack {
  constructor( encryptionPassword = undefined ) {
    if( encryptionPassword ) {
      this.encryptionPassword = crypto.createHash( "sha256" )
      .update( String( encryptionPassword ) ).digest( "base64" ).substr( 0 , 32 ) ;
    }
  }
